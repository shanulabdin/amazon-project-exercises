...
document.querySelectorAll('.js-link-primary')
  .forEach((link) => {
    link.addEventListener('click', () => {
      ...
      const updateCartQuantity = document.querySelector(`.js-cart-item-container-${productId}`)
      updateCartQuantity.classList.add('update-quantity-link');
    });
  });
...
document.querySelectorAll('.js-save-quantity-link')
  .forEach((link) => {
    link.addEventListener('click', () => {
      ...
      const saveButton = document.querySelector(`.js-cart-item-container-${productId}`);
